    ...
    <div style={{ minHeight: '100vh', background: '#09090d', color: '#fff', paddingTop: '72px' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
          ...
          <div style={{
            ...
            <button
              ...
              title={isWishlisted(product._id) ? "Unlike item" : "Like item"}
              style={{
                position: 'absolute',
                top: '20px',
                right: '20px',
            ...
            >
              <Heart
                ...
                color={isWishlisted(product._id) ? '#ef4444' : '#fff'}
              />
            </button>
        ...
        <div style={{
          ...
          {(() => {
            const productQty = getProductQty(product?._id);
                ...
                {productQty > 0 ? (
                  <div>
                    ...
                    <div style={{ display: 'inline-flex', alignItems: 'center', background: '#181820', borderRadius: '8px', border: '1px solid #d4af37', padding: '4px' }}>
                      <button onClick={() => decrementProduct(product?._id)} style={{ background: 'none', border: 'none', color: '#fff', padding: '6px 14px', cursor: 'pointer' }}>
                        <Minus size={16} />
                      </button>
